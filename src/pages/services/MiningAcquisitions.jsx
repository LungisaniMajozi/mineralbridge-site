  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-20">
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(to bottom, rgba(245, 158, 11, 0.9), rgba(217, 119, 6, 0.95)), url('https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=1920')`,
        }}
      >
