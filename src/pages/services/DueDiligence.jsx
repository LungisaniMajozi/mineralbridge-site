        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-xl font-light italic mb-8 border-l-2 border-amber-500 pl-4 bg-[#1E293B]/50 py-2">
              "I need to verify mineral authenticity and supplier credentials"
            </p>
            ...
            <div className="bg-[#1E293B] border border-[#1E293B] rounded-3xl p-8 mb-10 shadow-sm">
              ...
              <p className="text-lg text-slate-300 leading-relaxed font-light">
                Comprehensive due diligence on behalf of buyers, verifying
                authenticity and quality to ensure smooth transactions. We conduct
                thorough background checks and quality assessments to protect your
                investment.
              </p>
            </div>
            ...
            >
              Request Assessment <ChevronRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Link>
          </motion.div>
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-tl from-slate-900/40 via-transparent to-amber-500/20 z-10 pointer-events-none" />
            <img 
              src="/images/min2.png" 
              alt="Due Diligence" 
